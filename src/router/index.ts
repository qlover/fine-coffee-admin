    ...
    children: [
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "permission-page" */ "@/views/auth/page.vue"
          ),
        name: "UserAuth",
        meta: {
          title: "userAuth"
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "permission-page" */ "@/views/auth/directive.vue"
          ),
        name: "RoleAuth",
        meta: {
          title: "RoleAuth"
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "permission-page" */ "@/views/auth/role.vue"
          ),
        name: "RuleAuth",
        meta: {
          title: "RuleAuth"
